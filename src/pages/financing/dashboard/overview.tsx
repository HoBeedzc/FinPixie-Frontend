...
function Dashboard() {
  ...
  return (
    <Card>
      <Typography.Title heading={5}>{t['financing.header']}</Typography.Title>
      <Divider />
      <Row>
        <Col flex={1}>
          <StatisticItem
            icon={<IconCalendar />}
            title={t['financing.totalAmount']}
            count={data.allContents}
            loading={loading}
            unit={t['financing.pecs']}
          />
        </Col>
        ...
        <Col flex={1}>
          <StatisticItem
            icon={<IconComments />}
            title={t['financing.latestRevenue']}
        ...
        <Col flex={1}>
          <StatisticItem
            icon={<IconIncrease />}
            title={t['financing.rateOfReturn']}
            count={
              <span>
                {data.growthRate}{' '}
                <IconCaretUp
