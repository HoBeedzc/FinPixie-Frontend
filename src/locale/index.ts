const i18n = {
  'en-US': {
    ...
    'menu.deposit.dashboard': 'Dashboard',
    'menu.financing': 'Financing',
    'menu.financing.dashboard': 'Dashboard',
    'menu.fund': 'Fund',
    'menu.fund.dashboard': 'Dashboard',
    'menu.stock': 'Stock',
    'menu.stock.dashboard': 'Dashboard',
    'menu.futures': 'Futures',
    'menu.futures.dashboard': 'Dashboard',
  ...
  'zh-CN': {
    ...
    'menu.deposit': '存款',
    'menu.deposit.dashboard': '仪表盘',
    'menu.financing': '理财',
    'menu.financing.dashboard': '仪表盘',
    'menu.fund': '基金',
    'menu.fund.dashboard': '仪表盘',
    'menu.stock': '股票',
    'menu.stock.dashboard': '仪表盘',
    'menu.futures': '期货',
    'menu.futures.dashboard': '仪表盘',
    'menu.user.info': '用户信息',
